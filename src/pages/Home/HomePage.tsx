  ...
  return (
    <div className="bg-[#1E1E1E] flex flex-col items-center w-full min-h-screen">
      <div className="w-full max-w-[1585px] flex-grow">
        ...
        <div 
          className="relative w-full min-h-[400px] md:min-h-[810px] flex flex-col justify-center items-start md:items-start text-white text-left md:text-left px-4 md:px-10 bg-cover bg-right md:bg-right bg-no-repeat"
        ...
        >
          ...
          <div className="max-w-[790px] px-1 md:px-3">
            <p className="[font-family:'Khula',Helvetica] text-[10px] w-50 h-auto md:text-xl font-light leading-relaxed">
              <span className="font-bold">Creatify</span> focuses on <span className="font-bold">connecting people</span> with <span className="font-bold">artists </span>
              specializing in <span className="font-bold">photography, videography, graphic design, video editing, and traditional art.</span>
              The platform makes it easy for clients to find the right artist for their needs, ensuring high-quality work with the convenience of
              <span className="font-bold"> free booking</span> and <span className="font-bold">direct communication</span>.
            </p>
          </div>
        </div>
        </div>
        ...
        <div className="relative w-full flex flex-col items-center bg-[#1E1E1E]">
          <img className="w-full max-w-[1550px]" src={N1} alt="Artwork" />
        <div className="absolute -bottom-[110px] right-[10px] md:-bottom-[130px] md:right-[90px] bg-[#7db23a] rounded-full shadow-lg p-0 md:p-10 text-center w-[180px] h-[180px] md:w-[420px] md:h-[420px]">
            <p className="absolute top-[7px] left-1 md:top-[120px] md:left-[10px] text-white font-bold text-xs md:text-lg px-4 py-10 md:px-10 md:py-10">
              Creatify showcases artists and their creations, making it easy to discover a diverse range of talent for any project.
            </p>
          </div>
        </div>
        ...
        <div className="w-full h-[150px] text-center py-[170px] md:py-[200px] px-6 max-w-4xl mx-auto">
          <p className="text-white text-lg md:text-xl font-bold mb-4">Got questions? We’ve got answers!</p>
          <p className="text-white text-sm md:text-lg mb-6 px-6">
            Check out our <span className="font-bold">FAQs</span> to find everything you need to know about booking artists, exploring creative options, and making the most of your experience with <span className="font-bold">Creatify</span>.
          </p>
          <img
        ...
        {/* Join Us Section */}
        <div className="relative w-screen h-[450px] md:h-screen bg-[url('src/assets/ww-1.png')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center pt-4 md:py-24 md:px-6">
